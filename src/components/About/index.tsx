        ...
        <div className={styles.about_info}>
          <div className={styles.about_text}>
            ...
            <p>
              ...
              СТРІЛЬЦІВ ІЗ ГВИНТІВКАМИ ВЕДЕМО НА &quot;Полігон Полігон&quot; в
              Демидові та ССК{' '}
              <p>
                ДЛЯ РОБОТИ ІЗ ПІСТОЛЕТОМ ЧИ ДЛЯ ОЗНАЙОМЧИХ ЗАНЯТЬ ІЗ
                ПОЧАТКІВЦЯМИ МИ ОБИРАЄМО ТИР, У ВИПАДКУ НАПРАЦЮВАНЬ ЕЛЕМЕНТІВ
                САМОЗАХИСТУ, ТАКТИКИ ЧИ КОРОТКИХ СПОРТИВНИХ ВПРАВ ПРАЦЮЄМО НА
                ССК “ПРАКТИКА” В КАПІТАНІВЦІ. РОБОТУ НА ДИСТАНЦІЇ ДО 300 М ДЛЯ
                БІЛЬШ ДОСВІДЧЕНИХ СТРІЛЬЦІВ ІЗ ГВИНТІВКАМИ ВЕДЕМО НА
                &quot;Полігон Полігон&quot; в Демидові та ССК
                &quot;СТРІЛОК&quot; В БРОВАРАХ.
              </p>
              СТРІЛОК” В БРОВАРАХ.
            </p>
            <p className={styles.bold}>
              ...
              відповідальність ТА НАВИЧКИ, ЯКІ СЬОГОДНІ Є ОБОВʼЯЗКОВИМИ ДЛЯ
              КОЖНОГО.
            </p>
            <p>
