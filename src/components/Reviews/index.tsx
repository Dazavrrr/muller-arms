...
const Reviews = () => {
  ...
  const reviews = [
    {
      text: '“ОЛЕКСАНДР МАЄ ВЕЛИКИЙ ДОСВІД РОБОТИ В СФЕРІ ФІЗИЧНОЇ БЕЗПЕКИ, ДОСВІД ПРАКТИЧНОГО ВИКОРИСТАННЯ ЗБРОЇ' +
  ...
  return <section className={styles.reviews}>
    ...
    <div className={styles.swiper_container}>
      <Swiper loop spaceBetween={30} navigation={{
        nextEl: ".image-swiper-button-next",
        prevEl: ".image-swiper-button-prev",
      }} modules={[Navigation]} className="mySwiper" slidesPerView={2.7}>
        {reviews.map((r, i) => (
          <div key={i}>
            <SwiperSlide>
