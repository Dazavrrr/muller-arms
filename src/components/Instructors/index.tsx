...
import InstructorMuller from 'public/images/InstructorMuller.png'
import InstructorChizh from 'public/images/InstructorChizh.png'

const Instructors = () => {
  return <div className={styles.instructors}>
      <div>
        <h1 className={styles.instructors_title}>Наші ТРЕНЕРИ</h1>
    ...
    <div className={styles.instructors_cards}>
      <div className={styles.instructors_card}>
        ...
        <div className={styles.instructors_info}>
            <a href='https://www.instagram.com/instructor_muller/' className={styles.instructors_infoTitle}>Олександр Мельник <span className={styles.orange}>“instructor_Muller”</span></a>
      ...
      <div className={styles.instructors_card}>
        ...
        <div className={styles.instructors_info}>
          <a href='https://www.instagram.com/pozyvniy_chizh/' className={styles.instructors_infoTitle}>Олександр Чиж <span className={styles.orange}>   “pozyvniy_chizh”</span></a>
          <p className={styles.instructors_infoText}>
